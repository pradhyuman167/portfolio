...
const ContactSection = () => {
  ...
  const contactInfo = [
    {
      icon: Phone,
      title: "Phone",
      details: "+91 92562 27428",
      link: "tel:9256227428"
    },
    {
      icon: Mail,
      title: "Email",
      details: "pradhyumanpareek167@gmail.com",
      link: "mailto:pradhyumanpareek167@gmail.com"
    },
    {
      icon: MapPin,
      title: "Location",
  ...
  return (
    <section id="contact" className="section-padding py-24 bg-secondary/50">
